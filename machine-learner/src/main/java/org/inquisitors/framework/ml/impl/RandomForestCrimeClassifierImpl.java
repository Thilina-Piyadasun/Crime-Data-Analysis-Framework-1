 ...
 */
public class RandomForestCrimeClassifierImpl implements RandomForestClassifierModel ,Serializable{
    ...
    public MulticlassMetrics evaluateModel(TrainData dataFrame,double partition)throws Exception{
        ...
        if(model!=null){
           ...
           /* MulticlassClassificationEvaluator evaluator_recall = new MulticlassClassificationEvaluator()
            ...
            double precision = evaluator_recall.evaluate(predictions);
